 ...
 * 
 *         Generates a Frame window and sets up the KeyListener interface for
 *         non-blocking keyboard input.
 */
public class Term extends JApplet {
	...
	/**
	 * Constructor - Sets up the main terminal window and action listeners
	 */
	public Term() {
		...
		debugButton.addActionListener(new ActionListener() {
			...
			/*
			 * If the debug menu option selected, pop out the debug window
			 */
			public void actionPerformed(ActionEvent e) {
				DebugTerm.showDebug();
			}
	...
	/**
	 * Deletes the current text from the input line, ready for new text.
	 */
